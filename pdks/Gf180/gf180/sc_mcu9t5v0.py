...
gf180mcu_fd_sc_mcu9t5v0: Dict[str, h.ExternalModule] = {
    ...
    "endcap": _logic_module("endcap", "gf180mcu_fd_sc_mcu9t5v0", ["VDD", "VSS"]),
    "fill_1": _logic_module(
        "fill_1", "gf180mcu_fd_sc_mcu9t5v0", ["VDD", "VNW", "VPW", "VSS"]
    ),
    "fill_2": _logic_module(
        "fill_2", "gf180mcu_fd_sc_mcu9t5v0", ["VDD", "VNW", "VPW", "VSS"]
    ),
    "fill_4": _logic_module(
        "fill_4", "gf180mcu_fd_sc_mcu9t5v0", ["VDD", "VNW", "VPW", "VSS"]
    ),
    "fill_8": _logic_module(
        "fill_8", "gf180mcu_fd_sc_mcu9t5v0", ["VDD", "VNW", "VPW", "VSS"]
    ),
    ...
    "filltie": _logic_module("filltie", "gf180mcu_fd_sc_mcu9t5v0", ["VDD", "VSS"]),
    "hold": _logic_module(
