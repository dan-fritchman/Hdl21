...
buf_1 = _logic_module("buf_1", "High Speed", ["A", "VGND", "VNB", "VPB", "VPWR", "X"])
buf_2 = _logic_module("buf_2", "High Speed", ["A", "VGND", "VNB", "VPB", "VPWR", "X"])
buf_4 = _logic_module("buf_4", "High Speed", ["A", "VGND", "VNB", "VPB", "VPWR", "X"])
buf_8 = _logic_module("buf_8", "High Speed", ["A", "VGND", "VNB", "VPB", "VPWR", "X"])
...
inv_1 = _logic_module("inv_1", "High Speed", ["A", "VGND", "VNB", "VPB", "VPWR", "Y"])
inv_2 = _logic_module("inv_2", "High Speed", ["A", "VGND", "VNB", "VPB", "VPWR", "Y"])
inv_4 = _logic_module("inv_4", "High Speed", ["A", "VGND", "VNB", "VPB", "VPWR", "Y"])
inv_8 = _logic_module("inv_8", "High Speed", ["A", "VGND", "VNB", "VPB", "VPWR", "Y"])
