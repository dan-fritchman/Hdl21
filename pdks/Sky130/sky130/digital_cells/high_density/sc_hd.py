...
decap_12 = _logic_module("decap_12", "High Density", ["VGND", "VNB", "VPB", "VPWR"])
...
lpflow_bleeder_1 = _logic_module(
    "lpflow_bleeder_1",
    "High Density",
    ["SHORT", "VGND", "VNB", "VPB", "VPWR"],
)
lpflow_clkbufkapwr_1 = _logic_module(
    "lpflow_clkbufkapwr_1",
    "High Density",
    ["A", "KAPWR", "VGND", "VNB", "VPB", "VPWR", "X"],
)
lpflow_clkbufkapwr_2 = _logic_module(
    "lpflow_clkbufkapwr_2",
    "High Density",
    ["A", "KAPWR", "VGND", "VNB", "VPB", "VPWR", "X"],
)
lpflow_clkbufkapwr_4 = _logic_module(
    "lpflow_clkbufkapwr_4",
    "High Density",
    ["A", "KAPWR", "VGND", "VNB", "VPB", "VPWR", "X"],
)
lpflow_clkbufkapwr_8 = _logic_module(
    "lpflow_clkbufkapwr_8",
    "High Density",
    ["A", "KAPWR", "VGND", "VNB", "VPB", "VPWR", "X"],
)
lpflow_clkbufkapwr_16 = _logic_module(
    "lpflow_clkbufkapwr_16",
    "High Density",
    ["A", "KAPWR", "VGND", "VNB", "VPB", "VPWR", "X"],
)
lpflow_clkinvkapwr_1 = _logic_module(
    "lpflow_clkinvkapwr_1",
    "High Density",
    ["A", "KAPWR", "VGND", "VNB", "VPB", "VPWR", "Y"],
)
lpflow_clkinvkapwr_2 = _logic_module(
    "lpflow_clkinvkapwr_2",
    "High Density",
    ["A", "KAPWR", "VGND", "VNB", "VPB", "VPWR", "Y"],
)
lpflow_clkinvkapwr_4 = _logic_module(
    "lpflow_clkinvkapwr_4",
    "High Density",
    ["A", "KAPWR", "VGND", "VNB", "VPB", "VPWR", "Y"],
)
lpflow_clkinvkapwr_8 = _logic_module(
    "lpflow_clkinvkapwr_8",
    "High Density",
    ["A", "KAPWR", "VGND", "VNB", "VPB", "VPWR", "Y"],
)
lpflow_clkinvkapwr_16 = _logic_module(
    "lpflow_clkinvkapwr_16",
    "High Density",
    ["A", "KAPWR", "VGND", "VNB", "VPB", "VPWR", "Y"],
)
lpflow_decapkapwr_3 = _logic_module(
    "lpflow_decapkapwr_3",
    "High Density",
    ["KAPWR", "VGND", "VNB", "VPB", "VPWR"],
)
lpflow_decapkapwr_4 = _logic_module(
    "lpflow_decapkapwr_4",
    "High Density",
    ["KAPWR", "VGND", "VNB", "VPB", "VPWR"],
)
lpflow_decapkapwr_6 = _logic_module(
    "lpflow_decapkapwr_6",
    "High Density",
    ["KAPWR", "VGND", "VNB", "VPB", "VPWR"],
)
lpflow_decapkapwr_8 = _logic_module(
    "lpflow_decapkapwr_8",
    "High Density",
    ["KAPWR", "VGND", "VNB", "VPB", "VPWR"],
)
lpflow_decapkapwr_12 = _logic_module(
    "lpflow_decapkapwr_12",
    "High Density",
    ["KAPWR", "VGND", "VNB", "VPB", "VPWR"],
)
lpflow_inputiso0n_1 = _logic_module(
    "lpflow_inputiso0n_1",
    "High Density",
    ["A", "SLEEP_B", "VGND", "VNB", "VPB", "VPWR", "X"],
)
lpflow_inputiso0p_1 = _logic_module(
    "lpflow_inputiso0p_1",
    "High Density",
    ["A", "SLEEP", "VGND", "VNB", "VPB", "VPWR", "X"],
)
lpflow_inputiso1n_1 = _logic_module(
    "lpflow_inputiso1n_1",
    "High Density",
    ["A", "SLEEP_B", "VGND", "VNB", "VPB", "VPWR", "X"],
)
lpflow_inputiso1p_1 = _logic_module(
    "lpflow_inputiso1p_1",
    "High Density",
    ["A", "SLEEP", "VGND", "VNB", "VPB", "VPWR", "X"],
)
lpflow_inputisolatch_1 = _logic_module(
    "lpflow_inputisolatch_1",
    "High Density",
    ["D", "SLEEP_B", "VGND", "VNB", "VPB", "VPWR", "Q"],
)
lpflow_isobufsrc_1 = _logic_module(
    "lpflow_isobufsrc_1",
    "High Density",
    ["A", "SLEEP", "VGND", "VNB", "VPB", "VPWR", "X"],
)
lpflow_isobufsrc_2 = _logic_module(
    "lpflow_isobufsrc_2",
    "High Density",
    ["A", "SLEEP", "VGND", "VNB", "VPB", "VPWR", "X"],
)
lpflow_isobufsrc_4 = _logic_module(
    "lpflow_isobufsrc_4",
    "High Density",
    ["A", "SLEEP", "VGND", "VNB", "VPB", "VPWR", "X"],
)
lpflow_isobufsrc_8 = _logic_module(
    "lpflow_isobufsrc_8",
    "High Density",
    ["A", "SLEEP", "VGND", "VNB", "VPB", "VPWR", "X"],
)
lpflow_isobufsrc_16 = _logic_module(
    "lpflow_isobufsrc_16",
    "High Density",
    ["A", "SLEEP", "VGND", "VNB", "VPB", "VPWR", "X"],
)
lpflow_isobufsrckapwr_16 = _logic_module(
    "lpflow_isobufsrckapwr_16",
    "High Density",
    ["A", "SLEEP", "KAPWR", "VGND", "VNB", "VPB", "VPWR"],
)
lpflow_lsbuf_lh_hl_isowell_tap_1 = _logic_module(
    "lpflow_lsbuf_lh_hl_isowell_tap_1",
    "High Density",
    ["A", "VGND", "VPB", "VPWRIN", "VPWR", "X"],
)
lpflow_lsbuf_lh_hl_isowell_tap_2 = _logic_module(
    "lpflow_lsbuf_lh_hl_isowell_tap_2",
    "High Density",
    ["A", "VGND", "VPB", "VPWRIN", "VPWR", "X"],
)
lpflow_lsbuf_lh_hl_isowell_tap_4 = _logic_module(
    "lpflow_lsbuf_lh_hl_isowell_tap_4",
    "High Density",
    ["A", "VGND", "VPB", "VPWRIN", "VPWR", "X"],
)
lpflow_lsbuf_lh_isowell_4 = _logic_module(
    "lpflow_lsbuf_lh_isowell_4",
    "High Density",
    ["A", "LOWLVPWR", "VGND", "VNB", "VPB", "VPWR", "X"],
)
lpflow_lsbuf_lh_isowell_tap_1 = _logic_module(
    "lpflow_lsbuf_lh_isowell_tap_1",
    "High Density",
    ["A", "LOWLVPWR", "VGND", "VPB", "VPWR", "X"],
)
lpflow_lsbuf_lh_isowell_tap_2 = _logic_module(
    "lpflow_lsbuf_lh_isowell_tap_2",
    "High Density",
    ["A", "LOWLVPWR", "VGND", "VPB", "VPWR", "X"],
)
lpflow_lsbuf_lh_isowell_tap_4 = _logic_module(
    "lpflow_lsbuf_lh_isowell_tap_4",
    "High Density",
    ["A", "LOWLVPWR", "VGND", "VPB", "VPWR", "X"],
)
macro_sparecell = _logic_module(
    "macro_sparecell",
    "High Density",
