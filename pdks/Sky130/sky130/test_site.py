...
def test_sim_inv_auto():
    ...
    This test creates a testbench with a default-sized inverter, runs a DC operating point
    simulation with automatically included PDK models, and checks if the output voltage falls within
    a specific range. If the output voltage is within the specified range, the test passes.
    """
...
def test_sim_mosfets():
    ...
    class Sim:
        ...
        i1 = h.sim.Include(sky130.install.pdk_path / sky130.install.lib_path.parent / "corners/tt.spice")
        i2 = h.sim.Include(sky130.install.pdk_path / sky130.install.lib_path.parent / "r+c/res_typical__cap_typical.spice")
        i3 = h.sim.Include(sky130.install.pdk_path / sky130.install.lib_path.parent / "r+c/res_typical__cap_typical__lin.spice")
        i4 = h.sim.Include(sky130.install.pdk_path / sky130.install.lib_path.parent / "corners/tt/specialized_cells.spice")
        # inc = sky130.install.include(h.pdk.Corner.TYP)
...
def test_sim_diode():
    ...
    class Sim:
        ...
        i3 = h.sim.Include(sky130.install.pdk_path / sky130.install.lib_path.parent / "r+c/res_typical__cap_typical__lin.spice")
        i4 = h.sim.Include(sky130.install.pdk_path / sky130.install.lib_path.parent / "corners/tt/specialized_cells.spice")
        i5 = h.sim.Include(sky130.install.pdk_path / sky130.install.lib_path.parent / "corners/tt/rf.spice")
        # inc = sky130.install.include(h.pdk.Corner.TYP)
...
def test_sim_devcap():
    ...
    class Sim:
        ...
        class Tb:
            ...
            # Spotty coverage - not all of these work!
