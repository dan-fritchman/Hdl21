...
ls: Dict[str, h.ExternalModule] = {
    ...
    "buf_1": _logic_module(
        "buf_1", "Low Speed", ["A", "VGND", "VNB", "VPB", "VPWR", "X"]
    ),
    "buf_2": _logic_module(
        "buf_2", "Low Speed", ["A", "VGND", "VNB", "VPB", "VPWR", "X"]
    ),
    "buf_4": _logic_module(
        "buf_4", "Low Speed", ["A", "VGND", "VNB", "VPB", "VPWR", "X"]
    ),
    "buf_8": _logic_module(
        "buf_8", "Low Speed", ["A", "VGND", "VNB", "VPB", "VPWR", "X"]
    ),
    "buf_16": _logic_module(
        "buf_16", "Low Speed", ["A", "VGND", "VNB", "VPB", "VPWR", "X"]
    ),
    ...
    "decaphe_3": _logic_module(
        "decaphe_3", "Low Speed", ["VGND", "VNB", "VPB", "VPWR"]
    ),
    "decaphe_4": _logic_module(
        "decaphe_4", "Low Speed", ["VGND", "VNB", "VPB", "VPWR"]
    ),
    "decaphe_6": _logic_module(
        "decaphe_6", "Low Speed", ["VGND", "VNB", "VPB", "VPWR"]
    ),
    "decaphe_8": _logic_module(
        "decaphe_8", "Low Speed", ["VGND", "VNB", "VPB", "VPWR"]
    ),
    ...
    "diode_2": _logic_module(
        "diode_2", "Low Speed", ["DIODE", "VGND", "VNB", "VPB", "VPWR"]
    ),
    ...
    "inv_1": _logic_module(
        "inv_1", "Low Speed", ["A", "VGND", "VNB", "VPB", "VPWR", "Y"]
    ),
    "inv_2": _logic_module(
        "inv_2", "Low Speed", ["A", "VGND", "VNB", "VPB", "VPWR", "Y"]
    ),
    "inv_4": _logic_module(
        "inv_4", "Low Speed", ["A", "VGND", "VNB", "VPB", "VPWR", "Y"]
    ),
    "inv_8": _logic_module(
        "inv_8", "Low Speed", ["A", "VGND", "VNB", "VPB", "VPWR", "Y"]
    ),
...
low_speed = SimpleNamespace()

for name, mod in ls.items():
    setattr(low_speed, name, mod)
