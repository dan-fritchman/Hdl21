...
hdll: Dict[str, h.ExternalModule] = {
    ...
    "a21o_6": _logic_module(
        "a21o_6",
        "High Density Low Leakage",
        ["A1", "A2", "B1", "VGND", "VNB", "VPB", "VPWR", "X"],
    ),
    "a21o_8": _logic_module(
        "a21o_8",
        "High Density Low Leakage",
        ["A1", "A2", "B1", "VGND", "VNB", "VPB", "VPWR", "X"],
    ),
    ...
    "and2_6": _logic_module(
        "and2_6",
        "High Density Low Leakage",
        ["A", "B", "VGND", "VNB", "VPB", "VPWR", "X"],
    ),
    "and2_8": _logic_module(
        "and2_8",
        "High Density Low Leakage",
        ["A", "B", "VGND", "VNB", "VPB", "VPWR", "X"],
    ),
    ...
    "clkmux2_1": _logic_module(
        "clkmux2_1",
        "High Density Low Leakage",
        ["A0", "A1", "S", "VGND", "VNB", "VPB", "VPWR", "X"],
    ),
    "clkmux2_2": _logic_module(
        "clkmux2_2",
        "High Density Low Leakage",
        ["A0", "A1", "S", "VGND", "VNB", "VPB", "VPWR", "X"],
    ),
    "clkmux2_4": _logic_module(
        "clkmux2_4",
        "High Density Low Leakage",
        ["A0", "A1", "S", "VGND", "VNB", "VPB", "VPWR", "X"],
    ),
    ...
    "diode_4": _logic_module(
        "diode_4",
        "High Density Low Leakage",
        ["DIODE", "VGND", "VNB", "VPB", "VPWR"],
    ),
    "diode_6": _logic_module(
        "diode_6",
        "High Density Low Leakage",
        ["DIODE", "VGND", "VNB", "VPB", "VPWR"],
    ),
    "diode_8": _logic_module(
        "diode_8",
        "High Density Low Leakage",
        ["DIODE", "VGND", "VNB", "VPB", "VPWR"],
    ),
    ...
    "inputiso0n_1": _logic_module(
        "inputiso0n_1",
        "High Density Low Leakage",
        ["A", "SLEEP_B", "VGND", "VNB", "VPB", "VPWR", "X"],
    ),
    "inputiso0p_1": _logic_module(
        "inputiso0p_1",
        "High Density Low Leakage",
        ["A", "SLEEP", "VGND", "VNB", "VPB", "VPWR", "X"],
    ),
    "inputiso1n_1": _logic_module(
        "inputiso1n_1",
        "High Density Low Leakage",
        ["A", "SLEEP_B", "VGND", "VNB", "VPB", "VPWR", "X"],
    ),
    "inputiso1p_1": _logic_module(
        "inputiso1p_1",
        "High Density Low Leakage",
        ["A", "SLEEP", "VGND", "VNB", "VPB", "VPWR", "X"],
    ),
    ...
    "isobufsrc_8": _logic_module(
        "isobufsrc_8",
        "High Density Low Leakage",
        ["A", "SLEEP", "VGND", "VNB", "VPB", "VPWR", "X"],
    ),
    "isobufsrc_16": _logic_module(
        "isobufsrc_16",
        "High Density Low Leakage",
        ["A", "SLEEP", "VGND", "VNB", "VPB", "VPWR", "X"],
    ),
    ...
    "mux2_12": _logic_module(
        "mux2_12",
        "High Density Low Leakage",
        ["A0", "A1", "S", "VGND", "VNB", "VPB", "VPWR", "X"],
    ),
    "mux2_16": _logic_module(
        "mux2_16",
        "High Density Low Leakage",
        ["A0", "A1", "S", "VGND", "VNB", "VPB", "VPWR", "X"],
    ),
    ...
    "muxb4to1_1": _logic_module(
        "muxb4to1_1",
        "High Density Low Leakage",
        ["D[3]", "D[2]", "D[1]", "D[0]", "S[3]", "S[2]", "S[1]", "S[0]", "VGND"],
    ),
    "muxb4to1_2": _logic_module(
        "muxb4to1_2",
        "High Density Low Leakage",
        ["D[3]", "D[2]", "D[1]", "D[0]", "S[3]", "S[2]", "S[1]", "S[0]", "VGND"],
    ),
    "muxb4to1_4": _logic_module(
        "muxb4to1_4",
        "High Density Low Leakage",
        ["D[3]", "D[2]", "D[1]", "D[0]", "S[3]", "S[2]", "S[1]", "S[0]", "VGND"],
    ),
    "muxb8to1_1": _logic_module(
        "muxb8to1_1",
        "High Density Low Leakage",
        ["D[7]", "D[6]", "D[5]", "D[4]", "D[3]", "D[2]", "D[1]", "D[0]", "S[7]"],
    ),
    "muxb8to1_2": _logic_module(
        "muxb8to1_2",
        "High Density Low Leakage",
        ["D[7]", "D[6]", "D[5]", "D[4]", "D[3]", "D[2]", "D[1]", "D[0]", "S[7]"],
    ),
    "muxb8to1_4": _logic_module(
        "muxb8to1_4",
        "High Density Low Leakage",
        ["D[7]", "D[6]", "D[5]", "D[4]", "D[3]", "D[2]", "D[1]", "D[0]", "S[7]"],
    ),
    "muxb16to1_1": _logic_module(
        "muxb16to1_1",
        "High Density Low Leakage",
        ["D[15]", "D[14]", "D[13]", "D[12]", "D[11]", "D[10]", "D[9]", "D[8]"],
    ),
    "muxb16to1_2": _logic_module(
        "muxb16to1_2",
        "High Density Low Leakage",
        ["D[15]", "D[14]", "D[13]", "D[12]", "D[11]", "D[10]", "D[9]", "D[8]"],
    ),
    "muxb16to1_4": _logic_module(
        "muxb16to1_4",
        "High Density Low Leakage",
        ["D[15]", "D[14]", "D[13]", "D[12]", "D[11]", "D[10]", "D[9]", "D[8]"],
    ),
    ...
    "nand2_12": _logic_module(
        "nand2_12",
        "High Density Low Leakage",
        ["A", "B", "VGND", "VNB", "VPB", "VPWR", "Y"],
    ),
    "nand2_16": _logic_module(
        "nand2_16",
        "High Density Low Leakage",
        ["A", "B", "VGND", "VNB", "VPB", "VPWR", "Y"],
    ),
    ...
    "nor4_6": _logic_module(
        "nor4_6",
        "High Density Low Leakage",
        ["A", "B", "C", "D", "VGND", "VNB", "VPB", "VPWR", "Y"],
    ),
    "nor4_8": _logic_module(
        "nor4_8",
        "High Density Low Leakage",
        ["A", "B", "C", "D", "VGND", "VNB", "VPB", "VPWR", "Y"],
    ),
...
low_leakage = SimpleNamespace()

for name, mod in hdll.items():
    setattr(low_leakage, name, mod)
